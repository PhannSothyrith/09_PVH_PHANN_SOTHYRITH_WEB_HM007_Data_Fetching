...
const CardFantasyComponent = async () => {
    const movieData = await getMovieByGenre("Fantasy")
  return (
      ...
      <div key={data.movie_id} className="mt-3">
        ...
        >
          <img
            ...
            className="w-[350px] shadow rounded-md overflow-x-auto  border "
          />
...
export default CardFantasyComponent